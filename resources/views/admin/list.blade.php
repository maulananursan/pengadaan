                ...
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{$adm->alamat}}</td>
                      <td>
                        <button class="btn btn-primary btn-sm ubah" data-toggle="modal" data-target="#ubahModal"  data-id_admin="{{$adm->id_admin}}" data-nama="{{$adm->nama}}" data-email="{{$adm->email}}" data-alamat="{{$adm->alamat}}">
                          <i class="fas fa-user-edit" ></i> Ubah
                        </button>
                        <a href="/hapusAdmin/{{$adm->id_admin}}" class="konfirmasi">
