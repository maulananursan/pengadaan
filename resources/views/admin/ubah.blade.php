      ...
      <div class="modal-body">
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <input type="email" class="form-control email" id="u_email" name="u_email" placeholder="Masukkan Email Anda" >
            </div>
            <div class="form-group">
              <label for="exampleInputEmail1">Alamat</label>
              <textarea class="form-control alamat" rows="3" id="u_alamat" name="u_alamat" placeholder="Masukkan Alamat Anda" ></textarea>
            </div>
          </div>
          <!-- /.card-body -->
