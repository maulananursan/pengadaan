    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Registrasi</h2>
          <p>Daftarkan usahamu agar bisa melakukan pengajuan</p>
        </div>

        <div class="row">

          <!-- Fungsi menampilkan allert yang bersumber dari controller Registrasi -->
          ...
          @if(\Session::has('gagal'))
            ...
            @endif
         <!--  End Fungsi menampilkan allert yang bersumber dari controller Registrasi -->
          
          <div class="col-lg-12 mt-5 mt-lg-0 d-flex align-items-stretch">
            <form action="/regis" method="post" role="form" class="php-email-form">

              <!-- Fungsi melindungi form inputan agar aman menghsilkan token -->
              {{csrf_field()}}
              <!-- End Fungsi melindungi form inputan agar aman -->
