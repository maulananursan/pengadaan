                ...
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><button class="btn btn-secondary detail" data-toggle="modal" data-target="#pengajuanModal" data-id_pengadaan="{{$p->id_pengadaan}}" data-nama_pengadaan="{{$p->nama_pengadaan}}" data-anggaran="{{$p->anggaran}}"><i class="fa fa-plus"></i> Ajukan</button></td>
                    </tr>
                    @endforeach
                  </tbody>
                </table>
