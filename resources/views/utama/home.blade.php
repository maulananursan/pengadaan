...
<body>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          <h1>Memberikan Keempatan Kepada UMKM</h1>
          <h2>Kami memeberikan kesempatan kepada UMKM yang ingin mengajukan pengajuan barang atau jasa yang dimiliki </h2>
        ...
        <div class="row">
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box">
              ...
              <p>Bagi peserta yang ingin mengajukan pengajuan peserta wajib terdaftar dan memiliki izin usaha</p>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box">
              ...
              <p>Bagi kamu yang memiliki usaha sudah atau sama dengan 3 tahun bisa mengajukan permohonan</p>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box">
              ...
              <p>Usaha kamu wajib memiliki badan humum minimal CV dan sudah terdaftar sekurang kurangnya 3 tahun</p>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in" data-aos-delay="400">
            <div class="icon-box">
              ...
              <p>Untuk rekening usaha wajib terpisah dengan rekening pribadi dan bank harus menggunakan bank BUMN</p>
            </div>
          </div>
    ...
    <section id="portfolio" class="portfolio">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          ...
          <p>Berikut daftar Pengadaan barang dan jasa yang sedang aktif</p>
        </div>
        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app" style="text-align: center;">
            <a href="{{$p->deskripsi}}" target="_blank">
              <div class="portfolio-img"><img style="width: 200px; height: 200px; " src="{{asset (Storage::url($p->gambar))}}" class="img-fluid" alt=""></div>
      ...
      <div class="container" data-aos="zoom-in">
        ...
        <div class="row">
          <div class="col-lg-9 text-center text-lg-start">
            ...
            <p> Silahkan daftarkan usahamu agar bisa mengajukan penganjuan yang sedang dibutuhkan</p>
          </div>
  ...
  <footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            <h3>Pengadaan</h3>
            <p>
              Jl. Husni Hamid No. 1<br>
              Nagasari Karawang 41312<br>
              Indonesia<br><br>
              <strong>Telepon:</strong> (0267) 811234<br>
              <strong>Email:</strong> info@pengadankrw.com<br>
            </p>
          </div>

          <div class="col-lg-3 col-md-6 footer-links">
            <h4>Media Sosial Kami</h4>
            <p>Bergabung dengan sosial media kami untuk informasi terbaru</p>
    ...
    <div class="container footer-bottom clearfix">
      <div class="copyright">
        &copy; Copyright <strong><span>Pengadaan</span></strong> 2021
      </div>
      <div class="credits">
